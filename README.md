...
Initially providing 
  * a declarative interface for configuring Users and Groups of a local openldap/slapd deployment being used for SSH authentication,
  * and
  * a declarative interface for binding openldap/slapd Users and/or Groups to local Linux Groups (via /etc/security/group.conf) for the purpose of managing authorization
